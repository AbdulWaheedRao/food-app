...
class PizzaFastFood extends StatefulWidget {
  const PizzaFastFood({super.key});

  @override
  State<PizzaFastFood> createState() => _PizzaFastFoodState();
}

class _PizzaFastFoodState extends State<PizzaFastFood> {
  final fireStore = FirebaseFirestore.instance.collection('pizza').snapshots();
