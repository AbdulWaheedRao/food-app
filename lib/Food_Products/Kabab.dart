...
class KababFastFood extends StatefulWidget {
  const KababFastFood({super.key});

  @override
  State<KababFastFood> createState() => _KababFastFoodState();
}

class _KababFastFoodState extends State<KababFastFood> {
  final fireStore = FirebaseFirestore.instance.collection('kabab').snapshots();
