...
class NuggetsFastFood extends StatefulWidget {
  const NuggetsFastFood({super.key});

  @override
  State<NuggetsFastFood> createState() => _NuggetsFastFoodState();
}

class _NuggetsFastFoodState extends State<NuggetsFastFood> {
  final fireStore =
      FirebaseFirestore.instance.collection('nuggets').snapshots();
