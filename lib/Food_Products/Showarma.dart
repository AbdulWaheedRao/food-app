...
class ShowarmaFastFood extends StatefulWidget {
  const ShowarmaFastFood({super.key});

  @override
  State<ShowarmaFastFood> createState() => _ShowarmaFastFoodState();
}

class _ShowarmaFastFoodState extends State<ShowarmaFastFood> {
  final fireStore =
      FirebaseFirestore.instance.collection('showarma').snapshots();
